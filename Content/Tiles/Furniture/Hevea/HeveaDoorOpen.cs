...
public class HeveaDoorOpen : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileID.Sets.CloseDoorID[Type] = ModContent.TileType<HeveaDoorClosed>();
        ...
        AddMapEntry(HeveaFurnitureUtils.MapColor, Language.GetText("MapObject.Door"));
